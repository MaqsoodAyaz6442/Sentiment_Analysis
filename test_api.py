...
Original file is located at
    https://colab.research.google.com/drive/1pDSQ3eVYgirzC6RcTHSZy0nn4BTi7hGP
"""

import subprocess

# Install required packages
subprocess.run(['pip', 'install', 'uvicorn', 'nest-asyncio'])
subprocess.run(['pip', 'install', 'fastapi', 'httpx'])
